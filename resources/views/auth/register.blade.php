...
<div class="bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            @error('nama') <p class="mt-1 text-xs text-red-400 ml-1">{{ $message }}</p> @enderror
        </div>
        ...
        <div>
            ...
            @error('nis_nisn') <p class="mt-1 text-xs text-red-400 ml-1">{{ $message }}</p> @enderror
        </div>
        ...
        <div>
            ...
            @error('kelas') <p class="mt-1 text-xs text-red-400 ml-1">{{ $message }}</p> @enderror
        </div>
        ...
        <div>
            ...
            @error('email') <p class="mt-1 text-xs text-red-400 ml-1">{{ $message }}</p> @enderror
        </div>
    ...
    <p class="mt-6 text-center text-sm text-gray-400">
        Sudah punya akun? 
        <a href="{{ route('login') }}" class="font-bold text-blue-400 hover:text-blue-300 transition">Masuk di sini</a>
    </p>
    
    <div class="mt-4 text-center">
        <p class="text-xs text-gray-600">
            Dengan mendaftar, Anda menyetujui <a href="#" class="underline hover:text-gray-500">Syarat & Ketentuan</a> dan <a href="#" class="underline hover:text-gray-500">Kebijakan Privasi</a>.
        </p>
    </div>
</div>
