...
@section('title', 'Masuk - Perpustakan Digital')
...
<div class="text-center mb-8">
    ...
    <h2 class="text-2xl font-bold text-white mb-1">Perpustakan Digital</h2>
...
<div class="bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div class="flex items-center justify-between text-sm">
            ...
            <a href="{{ route('password.request') }}" class="text-blue-400 hover:text-blue-300 font-medium transition">Lupa kata sandi?</a>
        </div>
...
<p class="mt-8 text-center text-xs text-gray-600">
    Perpustakan Digital &copy; {{ date('Y') }}
</p>
@endsection
