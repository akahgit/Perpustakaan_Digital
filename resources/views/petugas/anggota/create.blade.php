...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-xl font-bold text-white">Form Pendaftaran Anggota</h2>
            <p class="text-sm text-slate-400">Isi data diri dan buat akun login untuk anggota baru</p>
        </div>
    ...
    <form action="{{ route('petugas.anggota.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" required 
                           class="w-full bg-slate-800/50 border border-slate-600 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 @error('nama') border-red-500 @enderror"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" rows="3" 
                              class="w-full bg-slate-800/50 border border-slate-600 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-indigo-500 @error('alamat') border-red-500 @enderror"
        ...
        <div class="bg-[#1e293b] rounded-2xl border border-slate-700/50 p-8 shadow-xl">
            <div class="flex items-center gap-3 mb-6 border-b border-slate-700 pb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">Digunakan untuk akses katalog online oleh anggota</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required 
                           ...
                           placeholder="Misal: ahmad.santoso">
                    <p class="text-xs text-slate-500 mt-1">Harus unik, tidak boleh sama dengan user lain.</p>
                    @error('username') <p class="mt-1 text-xs text-red-400">{{ $message }}</p> @enderror
                </div>

                <!-- Password -->
                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-2">Password Awal <span class="text-red-400">*</span></label>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-slate-500 mt-1">Ketik ulang password yang sama persis.</p>
                </div>
            </div>
        </div>
